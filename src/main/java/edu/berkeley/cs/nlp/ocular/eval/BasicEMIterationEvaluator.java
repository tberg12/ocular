...
public class BasicEMIterationEvaluator implements EMIterationEvaluator {
	...
	private List<Tuple2<String, Map<String, EvalSuffStats>>> allEvals;
	private boolean learnFont;
	private String inputPath;
	private String outputPath;
	private int numEMIters;
	
	public BasicEMIterationEvaluator(Indexer<String> charIndexer, Indexer<String> langIndexer,
			List<Tuple2<String, Map<String, EvalSuffStats>>> allEvals, boolean learnFont, String inputPath,
			String outputPath, int numEMIters) {
